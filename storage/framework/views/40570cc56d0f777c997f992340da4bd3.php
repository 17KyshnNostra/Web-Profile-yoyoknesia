    ...
    <div class="flex flex-col md:flex-row md:justify-between gap-8">
      ...
      <div class="flex-1">
        <a href="/" class="flex items-center mb-4">
          <img src="<?php echo e(asset('img/yoyonesia.png')); ?>" class="h-8 me-3" alt="Yoyoknesia Logo" />
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <ul class="text-gray-500 dark:text-gray-400 text-sm space-y-2">
            ...
            <li><a href="<?php echo e(route('dokumentasi')); ?>" class="hover:underline">Services</a></li>
            <li><a href="<?php echo e(route('porto')); ?>" class="hover:underline">Portofolio</a></li>
            <li><a href="<?php echo e(route('tracking.form')); ?>" class="hover:underline">Tracking</a></li>
            <li><a href="<?php echo e(route('about-us')); ?>" class="hover:underline">About Us</a></li>
          </ul>
        </div>
...
</footer><?php /**PATH C:\Users\A C E R\OneDrive\Documents\MPTI\Yoyoknesia-Yoyonesia-Filament\resources\views/components/partials/footer.blade.php ENDPATH**/ ?>